...
var num3:number=1;
var num4:number=9;
var result2:number=num4-num3;
console.log(`Substraction Result= ${result2}`)
//Multiplication
var num5:number=2;
var num6:number=4;
var result3:number=num5*num6;
console.log(`Multiplication Result= ${result3}`);
//  Divison
var num7:number=64;
var num8:number=8;
var result4:number=num7/num8;
...
var Num1:number=6;
// calculate sum 
var Sum:number=Num1+Num1;
// print
console.log(`Sum= ${Sum}`);
//second program
var Multiply:number=Num1*Num1;
...
var names:string[]=["arbab","areeba","rajia","wazuha","aiman"];
...
var names:string[]=["arbab","ayesha","aiza","amna"];
for(let i=0;i<names.length;i++)
{
...
//list that stores several examples. Use your list to print a series of statements about these items, such as
 ...
 var Favtransport:string[]=["motorcycle","car","parado"];
...
var inviteGuest:string[]=["riya","ayesha","uswa","mariyam","marwa","urwa","areeba","samia"];
//function of invitation send
function SendInvitation1(inviteGuest:string)
{
...
var array:string[]=["Ayesha","Areeba","Arooj","Noor","Aiza"];
...
const Guest:string[]=["Amna","Fatima","Arzu","Naima"];
...
const NewGuest:string[]=["Arooj","Zara","Mariyam"];
//Add one new guest to the beginning of your array
...
// end of your program.
const Guestarray:string[]=["ayesha","arzu","mariyam","fatima","aiza"];
 //Remove guests 
...
console.log("In reverse alphabetical order without changing the order of the original list=",ReverseOrder);
//Sort your array so it’s stored in alphabetical order. Print the array to show that its order has been changed.
var Sorted:string[]=ReverseOrder.sort();
console.log("stored in alphabetical order=",Sorted);
// Sort to change your array so it’s stored in reverse alphabetical order. Print the list to show that its order has changed.
var ReverseOrdering:string[]=Sorted.sort().reverse();
...
// dinner.
const  GuestCount:string[]=["Ayesha","Areeba","Ramia","Aima","Munaza","Areeba","Zunaira","Aiman","Laraib"];
function SendInvitation2(GuestCount:string){
...
const Things:string[]=["Mountains","Rivers","Countries","Cities","Languages"];
var list=Things;
...
// lower case function
var city1:string="fsd";
var city2:string="fsd";
var city3:string="isb";
if(city1==city2)
{
...
var arr:string[]=["apple","mango","coconut","pomegrantte"];
if(arr[3]=="grapes"){
...
var alien_color2:string='yellow';
...
var Fruits:string[]=["apple","banana","pineapple","grapes","orange"];
...
var favFruits:string[]=["pineapple","grapes","orange"];
...
var UserNames:string[]=["admin","ayesha","fatima","zoha","batool"];
...
var age:number=29;
var usernames:string[]=["ayesha","fatima","abeera"];
...
//  everyone has a unique username.
 var current_users:string[]=["Ayesha","Fatma","Arooj","Zainab","Hira"];
 var new_users:string[]=["Arbab","Fatma","Mariyam","Hina","Ayesha"];
...
const Pizza:string[]=["BBQ Chicken Pizza","Hawaiian Pizza","Pepperoni Pizza"];
...
const Animals:string[]=["Bird","Dog","Monkey"];
...
//   value to show that Objects are storing the album information correctly. Add an optional parameter to make
//   _album() that allows you to store the number of tracks on an album. If the calling line includes a value for 
//    the number of tracks, add that value to the album’s Object. Make at least one new function call that 
//    includes the number of tracks on an album.

// Define the Album object type
interface Album {
    artist: string;
    title: string;
  ...
  function makeAlbum(artist: string, title: string, numberOfTracks?: number): Album {
    const album: Album = {
      artist,
      title,
    }
...
function Magicians_show(magicians: string[]): void {
    for (const magician of magicians) {
      console.log(magician);
    }
  }
  // magician's names
  const magiciansArray1: string[] = ["Magician1", "Magician2", "Magician3", "Magician4"];
...
function showMagicians1(magicians: string[]): void {
  ...
  // magicians great
  function makeGreat1(magicians: string[]): void {
    for (let i = 0; i < magicians.length; i++) {
      magicians[i] = `the Great ${magicians[i]}`;
    }
  }
  const magiciansArray2: string[] = ["Magician1", "Magician2", "Magician3", "Magician4"];
...
function showMagicians2(magicians: string[]): void {
  ...
  const magiciansArray: string[] = ["Magician1", "Magician2", "Magician3", "Magician4"];
  
  // Create a copy of the array with "the Great" added to each name
  const greatMagiciansArray: string[] = makeGreat([...magiciansArray]);
...
//   each time.
function make_sandwich(...itemsOfArray: string[]):void {
...
interface Car {
  ...
  function Car_Create(manufacturer: string, modelName: string, ...options: { [key: string]: any }[]): Car {
    const car: Car = {
      manufacturer,
      modelName,
    };
